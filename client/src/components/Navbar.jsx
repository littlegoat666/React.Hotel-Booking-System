...
const BookIcon = () => (
    <svg className='w-4 h-4 text-gray-700' aria-hidden='true' xmlns='http://www.w3.org/2000/svg' width='24' height='24' fill='none' viewBox='0 0 24 24' >
        <path stroke='currentColor' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M5 19V4a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v13H7a2 2 0 0 0-2 2Zm00a2 2 0 0 0 2 2h12M9 3V14m7 0v4' />
    </svg>
);
...
const Navbar = () => {
    ...
    return (
            <nav className={`fixed top-0 left-0 w-full flex items-center justify-between px-4 md:px-16 lg:px-24 xl:px-32 transition-all duration-500 z-50 ${ isScrolled ? 'bg-black/60 shadow-md text-black-700 backdrop-blur-lg py-3 md:py-4' : 'py-4 md:py-6'}`}>
                ...
                <div className='hidden md:flex items-center gap-4 lg:gap-8'>
                    { navLinks.map((link, i) => (
                        <a key={i} href={ link.path } className={`group flex flex-col gap-0.5 ${isScrolled ? 'text-black-700' : 'text-black'}`}>
                            {link.name}
